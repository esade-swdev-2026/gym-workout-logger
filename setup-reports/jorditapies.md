...
- Generated: 2026-09-22 07:29 UTC
...
| Check | Status | Fix |
|---|---|---|
| uv installed (uv 0.12.17 (x86_64-unknown-linux-gnu)) | pass | — |
| Python 3.13 available to uv | pass | — |
| PyPI reachable (uv can install a package) | pass | — |
| git installed (2.53.0) | pass | — |
| git identity set (jorditapies <jordi.tapiesbernado@alumni.esade.edu>) | pass | — |
| GitHub SSH authenticates (as jorditapies) | pass | — |
